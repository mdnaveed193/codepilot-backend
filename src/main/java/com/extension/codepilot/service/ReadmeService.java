...
public class ReadmeService {
	...
	public String generateReadme(PushRequest pushRequest) {
		...
		readme.append("# ").append(pushRequest.getProblemTitle()).append("\n\n");

		readme.append("\n\n");

		readme.append(getDifficultyBadge(pushRequest.getDifficulty())).append("\n\n");

		readme.append("## Problem Description\n\n");
		readme.append(pushRequest.getDescription()).append("\n\n");
	...
	private String getDifficultyBadge(String difficulty) {
		...
		return "![Difficulty](https://img.shields.io/badge/Difficulty-" + difficulty.trim().replace(" ", "%20")
				+ "-lightgrey)";
	}
}